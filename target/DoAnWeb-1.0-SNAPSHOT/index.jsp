                        ...
                        <!-- <div class="navbar__item navbar-user">
                            ...
                            <ul class="navbar-user__menu">
                                <li class="navbar-user__item">
                                    <a href="#!" class="navbar-user__link">Tài khoản của tôi</a>
                                </li>
                                <li class="navbar-user__item">
                                    <a href="#!" class="navbar-user__link">Yêu thích</a>
                                </li>
                                <li class="navbar-user__item">
                                    <a href="#!" class="navbar-user__link">Thông tin đơn hàng</a>
                                </li>
                                <li class="navbar-user__item navbar-user__item--separate">
                                    <a href="#!" class="navbar-user__link">Đăng xuất</a>
                                </li>
                            </ul>
                        </div> -->
                    </ul>
...
<%--                                </p>--%>
<%--                            </a>--%>
<%--                            <span class="price">378.000đ</span>--%>
<%--                            <div class="bottom">--%>
<%--                                <div class="star"><i class="fa-solid fa-star"></i> 5</div>--%>
<%--                                <button class="fav-btn"><i class="fa-regular fa-heart"></i> Yêu thích</button>--%>
<%--                            </div>--%>
...
<%--                            <div class="bottom">--%>
<%--                                <div class="star"><i class="fa-solid fa-star"></i> 3.8</div>--%>
<%--                                <button class="fav-btn"><i class="fa-regular fa-heart"></i> Yêu thích</button>--%>
<%--                            </div>--%>
<%--                        </div>--%>
<%--                        <div class="product-card">--%>
